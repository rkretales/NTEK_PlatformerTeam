...
namespace Lowscope.Saving.Data
{
    public class SaveGameJSON : SaveGame, IConvertSaveGame
    {
        ...
        public override bool ReadSaveFromPath(string savePath)
        {
            string data = "";
            ...
            SaveGameJSON saveGame;
            
            try
            {
                saveGame = JsonUtility.FromJson<SaveGameJSON>(data);
            }
            catch
            {
                return false;
        ...
        public SaveGame ConvertTo(StorageType storageType, string filePath, bool replace = true)
        {
            ...
            else
            {
                ...
                saveGameSQLite.ReadSaveFromPath(tempPath);
                ...
                // After replacing the file, we open it again with a new instance.
                saveGameSQLite = new SaveGameSqlite();
                saveGameSQLite.ReadSaveFromPath(filePath);
